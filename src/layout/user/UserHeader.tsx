...
>
  <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
    ...
    <div className="flex items-center justify-between w-full gap-2 px-3 py-3 
      border-b border-[#FFE7B3] dark:border-[#333333]
  ...
  text-[#1A1A1A] bg-[#fff8e7]
  border border-[#FFE7B3]
  hover:bg-[#FFE7B3]/60
  dark:text-white dark:bg-[#1A1A1A] dark:border-[#333333]
  dark:hover:bg-[#FFC428]/20
  transition"
>
  {isMobileOpen ? (
    <svg
    ...
    >
      ...
      <Link href="/" className="lg:hidden">
        <Image width={140} height={32}
          className="dark:hidden"
          src="/images/logo/logo-light.svg" alt="Logo" />
        <Image width={140} height={32}
      ...
      <button
        ...
        className="flex items-center justify-center w-10 h-10 rounded-lg
        text-[#1A1A1A] hover:bg-[#FFE7B3]/60
        dark:text-white dark:hover:bg-[#FFC428]/20
    ...
    {/* Right Buttons */}
    <div className={`${isApplicationMenuOpen ? "flex" : "hidden"} 
